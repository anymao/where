 ...
 */
internal class FragmentActivityCodeHacker(private val logger: Logger) {
...
//                        }
    ...
    private fun hackActivityDispatchTouchEvent(inputStream: InputStream): ByteArray {
        return inputStream.use {
            ...
            val visitor = FragmentActivityHacker(ASM6, cw)
            cr.accept(visitor, ClassReader.EXPAND_FRAMES)
            cw.toByteArray()
        }
    }

    private inner class FragmentActivityHacker(api: Int, classVisitor: ClassVisitor?) :
        ...
        override fun visitMethod(
            ...
            if (name == HACK_METHOD) {
                ...
                return FragmentActivityInsertMethodVisitor(api, mv)
            }
            return mv
        }
        ...
        private fun insertOverrideCode() {
            ...
            mv.visitMethodInsn(
                ...
                "(Landroidx/fragment/app/FragmentActivity;Landroid/view/MotionEvent;)V",
                false
            )
            mv.visitVarInsn(ALOAD, 0)
            mv.visitVarInsn(ALOAD, 1)
    ...
    private inner class FragmentActivityInsertMethodVisitor(
        api: Int,
